...
public class Robot extends TimedRobot
{
  ...
  {
    //-------------------------------------------Drivetrain------------------------------------------------------------- 
    driveTrain.arcadeDrive(xboxDrv.getLeftY(), xboxDrv.getRightX());
    ...
    //-----------------------------------------------INTAKE---------------------------------------------------
    if(xboxDrv.getLeftStickButtonPressed() && intake.getDeployedLimitSwitchState() == false)
    {
      intake.deployIntake();
    }
    else if(xboxDrv.getRightStickButtonPressed() && intake.getStowedLimitSwitchState() == false)
    {
      intake.stowIntake();
    }
